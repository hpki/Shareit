...
public class ItemRequestServiceImpl implements ItemRequestService {
    ...
    public ItemRequestServiceImpl(UserStorage userStorage, ItemStorage itemStorage, ItemRequestStorage itemRequestStorage) {
    ...
    public ItemRequestDto addItemRequest(long userId, ItemRequestDto itemRequestDto) {
        ItemRequest itemRequest = itemRequestStorage.save(ItemRequestMapper.toItemRequest(userStorage.findById(userId)
                .orElseThrow(() -> new UserNotFoundException("Пользователь не найден")), itemRequestDto));
    ...
    public ItemRequestDto getItemRequestById(long userId, long requestId) {
        if (userStorage.existsById(userId)) {
            ItemRequestDto itemRequestDto = ItemRequestMapper.toItemRequestDto(itemRequestStorage.findById(requestId)
                    .orElseThrow(() -> new ItemRequestNotFoundException("Запрос вещи не найден")));
