...
public class BookingControllerTest {
    ...
    void editBooking() throws Exception {
        when(bookingService.setApproved(anyLong(), anyLong(), anyBoolean())).thenReturn(bookingApproved);
    ...
    void getAllBookings() throws Exception {
        when(bookingService.getAll(anyLong(), anyString(), any())).thenReturn(List.of(booking));
